...
using Response = Vent.Shared.Responses.Response;
...
public class AccountsController : ControllerBase
{
    ...
    public AccountsController(DataContext context, IUserHelper userHelper,
        IConfiguration configuration, IEmailHelper emailHelper, IPublishEndpoint publishEndpoint)
    {
        _context = context;
    ...
    public async Task<ActionResult> Login([FromBody] LoginDTO model)
    {
        ...
        string ImagenDefault = $"https://localhost:7148/images/NoImage.png";
        string BaseUrl = $"https://localhost:7148/images/";
    ...
    public async Task<IActionResult> ConfirmEmailAsync(string userId, string token)
    {
        ...
        // 📤 Publicar evento
        await _publishEndpoint.Publish(new UserActivatedEvent
        {
    ...
    private TokenDTO BuildToken(User user, string imgUsuario)
    {
        ...
        if (RolUsuario != null)
        {
            ...
            LogoCompa = $"https://localhost:7229/images/NexxtplanetLLC.png";
            imgUsuario = $"https://localhost:7229/images/NexxtplanetLLC.png";
        }
        else
        {
