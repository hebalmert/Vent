...
public partial class IndexClients
{
    ...
    private async Task ShowModalAsync(int id = 0, bool isEdit = false)
    {
        ...
        if (isEdit)
        {
            ...
            dialog = await _dialogService.ShowAsync<EditClients>($"Editar Cliente", parameters, options);
        }
        else
        {
            dialog = await _dialogService.ShowAsync<CreateClients>($"Nuevo Cliente", options);
        }
