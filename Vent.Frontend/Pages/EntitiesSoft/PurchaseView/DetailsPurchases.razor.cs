...
public partial class DetailsPurchases
{
    ...
    [Parameter] public int Id { get; set; }  //Codigo del PurchaseId
    ...
    private async Task Cargar(int page = 1)
    {
        ...
        var responseHttpCountry = await _repository.GetAsync<Purchase>($"/api/purchases/{Id}");
    ...
    private async Task ShowModalAsync(int id = 0, bool isEdit = false)
    {
        ...
        if (isEdit)
        {
            ...
            dialog = await _dialogService.ShowAsync<EditPurchaseDetails>($"Editar Item", parameters, options);
        }
        else
        {
            var parameters = new DialogParameters
            ...
            dialog = await _dialogService.ShowAsync<CreatePurchaseDetails>($"Nuevo Item", parameters, options);
        }
